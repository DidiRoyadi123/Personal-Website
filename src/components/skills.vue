  ...
  <v-container>
    <div class="d-flex flex-column d-sm-flex flex-sm-row offset-md-1 mt-9">
      <v-col
        ...
        sm="5"
      >
        <h1 class="pb-5">Skill & Kompetensi</h1>
        <p>
         Saya berpengalaman dalam pembuatan website berbasis PHP & mySQL, dan terbiasa menggunakan framework vue JS dalam pengembangan frontend web dan biasa menggunakan GraphQL,saya juga menguasai framework CSS daiantaranya : Boostrap,Tailwind, dan vuetifyy. Dalam hal kegiatan administrasi saya memahami berbagai layanan microsoft office dan aturannya. dalam hal IT support saya telah tersertifikasi oleh Google melalui program google IT support<br />
          <span
            ><a
              href="https://www.credly.com/badges/07f06137-6ba3-46c0-880f-2fd4a3d3fdce/linked_in_profile"
              target="_blank"
              >Google IT Support</a
            ></span
          >.
        ...
        <v-btn
          ...
          href=" https://github.com/DidiRoyadi123"
          target="_blank"
          outlined
          ripple
      ...
      <v-col class="offset-md-1 offset-sm-1" cols="12" md="6" sm="5">
        <div id="myCanvasContainer" class="d-flex justify-center">
          <canvas width="auto" height="400" id="myCanvas">
            ...
            <ul>
              <a href="javascript:function() { return false; }">Adobe XD</a>
              <a href="javascript:function() { return false; }">HTML5</a>
              <a href="javascript:function() { return false; }">CSS</a>
              <a href="javascript:function() { return false; }">CCNA</a>
              ...
              <a href="javascript:function() { return false; }">COA</a>
              <a href="javascript:function() { return false; }">PHP</a>
              <a href="javascript:function() { return false; }">Postman</a>
              <a href="javascript:function() { return false; }">GraphQL</a>
              <a href="javascript:function() { return false; }">Linux</a>
              <a href="javascript:function() { return false; }">Figma</a>
              <a href="javascript:function() { return false; }">Bootstrap Vue</a>
              <a href="javascript:function() { return false; }">ElementUI</a>
              <a href="javascript:function() { return false; }">Cisco</a>
              <a href="javascript:function() { return false; }">codeigniter</a>
